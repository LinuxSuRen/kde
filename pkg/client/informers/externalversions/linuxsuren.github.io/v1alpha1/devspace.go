...
import (
	...
	versioned "github.com/linuxsuren/kde/pkg/client/clientset/versioned"
	internalinterfaces "github.com/linuxsuren/kde/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/linuxsuren/kde/pkg/client/listers/linuxsuren.github.io/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LinuxsurenV1alpha1().DevSpaces(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LinuxsurenV1alpha1().DevSpaces(namespace).Watch(context.TODO(), options)
			},
		},
		&linuxsurengithubiov1alpha1.DevSpace{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *devSpaceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&linuxsurengithubiov1alpha1.DevSpace{}, f.defaultInformer)
}

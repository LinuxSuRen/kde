...
func (f *FakeManager) AddMetricsServerExtraHandler(string, http.Handler) (err error) {
	return
}
...
func (f *FakeManager) GetHTTPClient() (client *http.Client) {
	return
}
...
func (f *FakeManager) GetControllerOptions() (spec config.Controller) {
	return
}

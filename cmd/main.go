...
func main() {
	...
	flag.StringVar(&systemNamespace, "system-namespace", "kde-system", "The system namespace for installation")
	opts := zap.Options{
		Development: true,
	}
	...
	if secureMetrics {
		...
		// https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.18.4/pkg/metrics/filters#WithAuthenticationAnedAuthorization
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "016e5cb8.linuxsuren.github.io",
	...
	if err = (&controller.DevSpacePodPodReconciler{
		Client: mgr.GetClient(),
	}).SetupWithManager(mgr); err != nil {

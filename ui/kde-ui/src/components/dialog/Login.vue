...
<template>
    <el-dialog :modelValue="visible" title="You need to login first." width="30%">
        <el-collapse accordion="true">
            ...
            <el-collapse-item title="Server in local" name="2">
                ...
                <div v-if="deviceAuthActive === 1">
                    Open <a :href="deviceAuthResponse.verification_uri" target="_blank">this link</a>, and type the
                    code: <span>{{ deviceAuthResponse.user_code }}. Then click the next step button.</span>
                </div>
